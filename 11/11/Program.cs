...
namespace _11
{
    class Hash
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"time: {(DateTime.Now.Ticks - OldTick) / 1000} ms\n\n");
            ...
            Console.WriteLine($"time: {(DateTime.Now.Ticks - Ticks) / 1000} ms\n\n");
            ...
            Console.WriteLine($"time: {(DateTime.Now.Ticks - OldTicks) / 1000} ms\n\n");
            Console.ReadKey();
        }
